import { footerLegalText, photoAttribution, visaRewardDisclaimer, theftProtectionDisclaimer } from "@/app/src/safestreet/components/FooterDisclaimer/FooterDisclaimer.constants";
