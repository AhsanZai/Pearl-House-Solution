...
import { useHeroSection } from "@/app/src/safestreet/hooks/heroSection/useHeroSection";
import LeadForm from "@/app/src/safestreet/components/LeadForm";
import { slides } from "@/app/src/safestreet/components/HeroSection/HeroSection.data";
      ...
      <div className="relative z-2 w-full max-w-7xl mx-auto px-6 md:px-10 min-h-[480px] lg:min-h-[520px] flex flex-col lg:flex-row items-center lg:items-stretch gap-6 py-10">
        ...
        <div className="flex-1 flex flex-col justify-center lg:pr-8">
          ...
          >
            ...
            <p className="text-[13px] font-medium leading-normal tracking-wide text-white/95">
